...
public class Notification_List extends AppCompatActivity {
    ...
    private void get_notifications() {
        ...
        try {
            ...
            httpost = new HttpPost("http://" + General_Data.SERVER_IP_ADDRESS + "/agriappserver/android/getnotificationall" +
                    ".php");
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    // TODO Auto-generated method stub
                    Toast.makeText(Notification_List.this, response, Toast.LENGTH_LONG).show();
                    pd.dismiss();
                    ...
                    try {
                        ...
                        list_notifications.setOnItemClickListener(new OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                Intent i = new Intent(getApplicationContext(), Notification_View.class);
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    // TODO Auto-generated method stub
                    Toast.makeText(Notification_List.this, "Error : " + e.getLocalizedMessage(), Toast
                            .LENGTH_LONG).show();
                    Log.d(General_Data.TAG, e.getLocalizedMessage());
                    pd.dismiss();
                }
